...
<Form.Group className="mb-3" >
    ...
    <Form.Control type="name" placeholder="Enter first name" id="name"  onChange={Handlechange}/>
  ...
  <Form.Group className="mb-3" >
    ...
    <Form.Control type="name" placeholder="Enter last name" id="last_name" onChange={Handlechange} />
    <Form.Text className="text-muted">
    </Form.Text>
  </Form.Group>
